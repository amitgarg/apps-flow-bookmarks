...
function activate(context) {
	...
	const myExtension = vscode.extensions.getExtension('DeepakPahawa.flowbookmark');
	...
	if (!projectDir) {
		vscode.window.showErrorMessage('teams-modular-packages not found in workspace');
		return;
	}
	...
	const treeDataProvider1 = new FlowBookmarksProvider(
		[],
		projectDir
	);
